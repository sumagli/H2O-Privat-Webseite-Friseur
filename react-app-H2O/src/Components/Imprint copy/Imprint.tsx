...
export default function Imprint2() {
    return (
        <div className={styles.imprint}>
            ...
            <div>
                <h2>Kontakt:</h2>
                <p>
                    Telefon: +49 711 340 670 9301<br />
                    E-Mail: office@sechano.com
                </p>
            </div>
            <div>
            ...
            <div>
                ...
                <p>
                    Quelle: <a href="https://e-recht24.de" target="_blank" rel="noopener noreferrer">e-recht24.de</a>
                </p>
