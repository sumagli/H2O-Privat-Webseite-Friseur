      ...
      <div className={styles.textContent}>
        ...
        {activeStep != 0 && (
          <Link
            ...
            className={`${styles.buttonBelow} ${
              isVisible
                ? styles.animateonvisiblebuttonBelow
                : styles.animateOutButtonBelow
            }`}
          >
